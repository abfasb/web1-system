          ...
          <form>
            <div class="grid gap-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  <input value="invalidemail" type="email" id="email" name="email"
              ...
              <button type="submit"
                class="inline-flex items-center justify-center gap-2 rounded-md border border-transparent bg-blue-500 py-3 px-4 text-sm font-semibold text-white transition-all hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Reset
                password</button>
            </div>
          </form>
          <!-- /Form -->
