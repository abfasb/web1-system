...
<div class="grid mt-[90px] sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    <div class="px-4 pt-8">
        ...
        <form class="mt-5 grid gap-6" action="<?php echo $_SERVER["PHP_SELF"] ?>" method="POST">
            ...
            <p class="text-lg font-medium">Delivery Address</p>
            <div class="relative">
            ...
            <div class="relative">
                ...
                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16 12a4 4 0 10-8 0 4 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
                    </svg>
                </div>
            </div>
            ...
            <label for="card-number" class="mt-4 mb-2 block text-sm font-medium">Card Number</label>
<div class="relative">
    <input type="text" id="card-number" name="card-number" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="xxxx-xxxx-xxxx-xxxx" />
    <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
...
<label for="expiry-date" class="mt-4 mb-2 block text-sm font-medium">Expiry Date</label>
<input type="text" id="expiry-date" name="expiry-date" class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="MM/YY" />
