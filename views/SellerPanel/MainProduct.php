    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            <span class="text-gray-400 font-bold">ADMIN</span>
                  <li class="mb-1 group">
            <a href="#" class="flex font-semibold items-center py-2 px-4 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100" onclick="alert('This section is only accessible for administrators.');">
                <i class="ri-home-2-line mr-3 text-lg"></i>
                <span class="text-sm">Dashboard</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="#" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle" onclick="alert('This section is only accessible for administrators.');">
            ...
            <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                <li class="mb-4">
                    <a href="#" class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3" onclick="alert('This section is only accessible for administrators.');">All</a>
                </li> 
                <li class="mb-4">
                    <a href="#" class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3" onclick="alert('This section is only accessible for administrators.');">Roles</a>
                </li> 
            </ul>
        </li>
        <li class="mb-1 group">
            <a href="#" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100" onclick="alert('This section is only accessible for administrators.');">
                        ...
                        <div id="filterDropdown" class="z-10 hidden w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                ...
                                <li class="flex items-center">
                                    ...
                                    <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Male(32)</label>
                                </li>
                                <li class="flex items-center">
                                    ...
                                    <label for="dell" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Female(23)</label>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<div id="updateProductModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    ...
    <div class="flex items-center space-x-4">
        ...
        <button type="button" class="text-red-600 inline-flex items-center hover:text-red-600 hover:bg-red-600 border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form method="GET" action="./delete.php" class="flex justify-center items-center space-x-4">
                ...
                <button type="submit" name="delete_product" class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">Yes, I'm sure</button>
            </form>
        </div>
    </div>
</div>
...
<div class="flex justify-center gap-4">
    <nav aria-label="Information Using Pagination">
        <ul class="flex items-center -space-x-px h-12 text-base gap-2 mt-4">
            <li>
                <a href="?page=<?php echo max($current_page - 1, 1); ?><?php if (!empty($search_query)) echo '&search_query=' . urlencode($search_query); ?>" class="flex items-center justify-center px-4 h-10 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <?php for ($i = 1; $i <= ceil($total_records / $records_per_page); $i++) {
                $active_class = ($current_page == $i) ? 'bg-blue-500 text-white' : 'bg-white text-gray-500 hover:bg-gray-100 hover:text-gray-700';
            ?>
                <li>
                    <a href="?page=<?php echo $i; ?><?php if (!empty($search_query)) echo '&search_query=' . urlencode($search_query); ?>" class="flex items-center justify-center px-4 h-10 leading-tight <?php echo $active_class; ?> border border-gray-300 dark:border-gray-700"><?php echo $i; ?></a>
                </li>
            <?php } ?>
            <li>
                <a href="?page=<?php echo min($current_page + 1, ceil($total_records / $records_per_page)); ?><?php if (!empty($search_query)) echo '&search_query=' . urlencode($search_query); ?>" class="flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
