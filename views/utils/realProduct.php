        ...
        <?php foreach ($products as $product): ?>
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 product-card" data-category-id="<?php echo $product['category_id'] ?>">
                <a href="../viewProduct.php?product_id=<?php echo $product['product_id']; ?>">
                    ...
                    $product_image = '../../pages/profile/uploads/' . $images[0];
                    ?>
                ...
                <div class="px-5 pb-5 product-details">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href = "../viewProduct.php?product_id=<?php echo $product['product_id']; ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
